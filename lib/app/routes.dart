...
class Routes {
  ...
  // Admin route names — used by admin_app.dart only (no builders here)
  static const admin = '/admin';
  static const allDriverAdmin = '/admin/all-drivers';
  static const allDonationAdmin = '/admin/all-donations';
  static const activityZones = '/admin/activity-zones';
  ...
  static Map<String, WidgetBuilder> routesMap = {
    ...
    donorEditProfile: (context) =>
        const AuthGuard(child: DonorEditProfileScreen()),
    driverEditProfile: (context) =>
        const AuthGuard(child: DriverEditProfileScreen()),
    ...
    completeProfile: (context) {
      final donor =
          ModalRoute.of(context)!.settings.arguments as DonorProfile;
      return AuthGuard(child: DonorProfileCompletionScreen(donor: donor));
    },
    dailyRoutDriver: (context) =>
        const AuthGuard(child: DailyRouteDriverPage()),
  };
}
