...
//     try {
//       // קודם עדכון פרטי היוזר
//       await _donorService.updateUserProfile(name: nameCtrl.text);

//       // אחר כך עדכון פרטי התורם
//       await _donorService.updateDonorProfile(
//         businessName: businessNameCtrl.text,
//         businessPhone: businessPhoneCtrl.text,
//         businessAddressId: donor!.businessAddress.id, // שולח את ה-ID של הכתובת
//         contactName: contactNameCtrl.text,
//         contactPhone: contactPhoneCtrl.text,
//         crn: crnCtrl.text,
//       );
